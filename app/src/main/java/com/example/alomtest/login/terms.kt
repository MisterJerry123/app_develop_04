...
import com.example.alomtest.databinding.ActivityTermsAcceptPageBinding
...
class terms : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("terms 비밀번호 인텐트 테스트",password)
        Log.d("terms 이름 인텐트 테스트",name)
        Log.d("terms 생년월일 인텐트 테스트",birthday)
        Log.d("terms 성별 인텐트 테스트",gender)
...
//
        ...
        val customDialog = Termsacceptpage_dialog(this,this)

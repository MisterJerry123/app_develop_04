...
//class Termsacceptpage_dialog(context: Context, private val activity: Activity) : Dialog(context) {
...
//                    SharedPreferenceUtils.saveData(context,"terms_agree_check",true.toString())
//                    Log.d("쉐프 체크", SharedPreferenceUtils.loadData(context, "terms_agree_check"))
//
//
//
//                    activity.recreate()

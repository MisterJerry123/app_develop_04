...
class FoodAdapter(private var mList: MutableList<food_list>) :
    ...
    inner class FoodViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        init {
            ...
            itemView.setOnClickListener {
                onItemClickListener?.invoke(mList[absoluteAdapterPosition].name)
            }
    }}
...
//    }
fun setFilteredList(mList: List<food_list>) {
//    mList.clear()

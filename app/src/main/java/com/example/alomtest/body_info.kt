...
//초기값 저장 함수
    fun loadHeight(context: Context): String {
        return loadData(context, KEY_HEIGHT, "180")
    }

    fun loadWeight(context: Context): String {
        return loadData(context, KEY_WEIGHT, "80")
    }

    fun loadBmi(context: Context): String {
        return loadData(context, KEY_BMI, "10")
    }
}
